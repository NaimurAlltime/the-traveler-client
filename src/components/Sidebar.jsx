...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72 pt-2 lg:pt-4 flex-col overflow-y-hidden bg-gray-950 duration-300 ease-linear dark:bg-slate-950 lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink className="flex gap-2 items-center" to="/dashboard">
          <img className="w-[72px]" src="/the-traveler-logo.png" alt="Logo" />
          <h2 className="text-white text-xl font-semibold text-center mt-3">
            The Traveler
          </h2>
        </NavLink>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/dashboard/banner"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-300 duration-300 ease-in-out hover:bg-gray-900 dark:hover:bg-gray-900 ${
                    pathname.includes("dashboard/banner") &&
                    "bg-gray-900 dark:bg-gray-500"
                  }`}
                >
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/dashboard/popular-packages" ||
                  pathname.includes("dashboard/popular-packages")
                }
              >
                {(handleClick, open) => {
                  return (
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <MdOutlineAddHomeWork className="text-lg" />
                  Home Page
                </NavLink>
              </li>
              {/* <!-- Menu Item Home page --> */}
