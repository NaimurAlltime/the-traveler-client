const Banner = () => {
  return (
    ...
    <div className="bg-slate-900">
      <div className="bg-[url('https://img.freepik.com/free-photo/woman-with-hat-sitting-chairs-beach-beautiful-tropical-beach-woman-relaxing-tropical-beach-koh-nangyuan-island_335224-1111.jpg?w=900&t=st=1693664752~exp=1693665352~hmac=991a55882b43f5062a5e44fe55a31693bf874e5b5659dfea7ac31d41b92ec033')] via-transparent bg-no-repeat w-full">
